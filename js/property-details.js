...
// // console.log(landlord1.rentals[0]);
...
// var tenantName = "Current Tenant: " + landlord1.rentals[0].tenantInfo.firstName + " " + landlord1.rentals[0].tenantInfo.lastName;
// var displayTenantEmail = "Current Tenant Email: " + landlord1.rentals[0].tenantInfo.email;
// var monthlyRentAmount = "Monthly Rental Amount: $" + landlord1.rentals[0].tenantInfo.monthlyRent;
// var leaseDateRange = "Lease Date Range: " + landlord1.rentals[0].tenantInfo.leaseStart + " - " + landlord1.rentals[0].tenantInfo.leaseEnd;

// var getTenantFirst = landlord1.rentals[0].tenantInfo.firstName;
// var getTenantLast = landlord1.rentals[0].tenantInfo.lastName;
// var getTenantEmail = landlord1.rentals[0].tenantInfo.email;
// var rentalAmount = landlord1.rentals[0].tenantInfo.monthlyRent;
